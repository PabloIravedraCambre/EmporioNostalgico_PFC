...
class usuario {
    ...
    public function createUser(){
        try {
            $conn = getDBConnection();
            $sentencia = $conn->prepare('INSERT INTO usuario(Nombre_Usuario, Correo_Usuario, Contrasenia_Usuario) VALUES (?,?,?)');
            $sentencia->bindParam(1, $this->nombreUsuario);
            $sentencia->bindParam(2, $this->correoUsuario);
            $sentencia->bindParam(3, $this->contraseniaUsuario);
            $sentencia->execute();
    ...
    public function updateUser() {
        try {
            $conn = getDBConnection();
            $sentencia = $conn->prepare('UPDATE usuario SET Nombre_Usuario = ?, Correo_Usuario = ?, Contrasenia_Usuario = ? WHERE ID_Usuario = ?');
            $sentencia->bindParam(1, $this->nombreUsuario);
            $sentencia->bindParam(2, $this->correoUsuario);
            $sentencia->bindParam(3, $this->contraseniaUsuario);
